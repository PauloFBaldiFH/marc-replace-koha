...
#   curl -sSL https://raw.githubusercontent.com/SEU_USUARIO/marc-replace-koha/main/install.sh | sudo bash
#
# Ou, se preferir revisar antes de rodar:
#   curl -O https://raw.githubusercontent.com/SEU_USUARIO/marc-replace-koha/main/install.sh
#   less install.sh
...
REPO_RAW_URL="https://raw.githubusercontent.com/SEU_USUARIO/marc-replace-koha/main/marc_replace.pl"
